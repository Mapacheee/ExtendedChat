...
public record EcMessages(
    ...
    public static EcMessages defaults() {
        return new EcMessages(
                ...
                "<green>Enter hex code (without #) or 'cancel' to cancel.",
                "<green>Enter colors separated by comma (e.g., red,blue) or 'cancel' to cancel.",
                "<red>Invalid hex color.",
                "<red>Invalid gradient colors.",
                "<green>Color updated.",
                "<green>Color removed.",
                "<red>Input cancelled.",
